...
% ------------------------------------------------------------------
% Formelblad Trans & Stat
% Version 0.71 IvTj, 2008-01
% Version 0.9  IvTj, 2008-03, inkluderad fördelningstabeller
% Version 0.91 IvTj, 2008-03-11, Rättat ett antal bugs 


\documentclass{article}

\usepackage[utf8]{inputenc}
% \usepackage{a4,graphicx,fullpage,amssymb}
...
% Ortogonalitetsrelationer <E_k,E_j> delta_ij%<<<
\medskip
\begin{tabular}[t]{|l|}
  \hline
   \\*[-9pt]
...
\textbf{Steiner's sats}: $\sigma^2=V(\xi)=E(\xi^2)-\mu^2 %=E(\xi^2)-[E(\xi)]^2
=\cases{
