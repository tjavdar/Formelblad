...
\else
 \small
 \Tr{Formula sheet Multivariate Calculus}{Formelblad Flervariabelanalys}
...
\section*{
\Tr{Formula Sheet Multivariate Calculus}
...
% Computation%<<<
 \item 
   ...
   \Tr{then}
      {är}
   $$
    \int_\gamma \bdF\circ \hat T\, |d\bdr|
  = \int_\gamma \bdF\circ d\bdr
  = \int_a^b \bdF(\bdr(t))\circ\bdr'(t)\,dt.
   $$%>>>
...
$$
    \int_\gamma \bdF\circ d\bdr = \int_\gamma\nabla\Phi\circ d\bdr
    = \Phi(B)-\Phi(A).
$$
%>>>
...
\item 
 ...
 \Tr{then}
    {då är}
$$
  \oint_{\partial\Omega} \bdF\circ d\bdr
...
% Computation %<<<
   \item 
     ...
     \Tr{then}
        {då är}
     $$
     \iint_{\mskip -12mu S} \bdF\circ\widehat\bdN\,dS
   = \pm\iint_{\mskip -12mu\Omega}
         \bdF(\bdr(u,v))\circ (\bdr'_u\times\bdr'_v)\,dudv.
     $$%>>>
...
%   If $S$ is the functional surface %<<<
   \item 
     ...
     \iint_{\mskip -12mu S} \bdF\circ\widehat\bdN\,dS
   = \pm\iint_{\mskip -12mu\Omega}
     \bdF(x,y,z(x,y))\circ\trevektor[-z'_x,-z'_y,1]\,dxdy.
     $$%>>>
...
%  Gauss %<<<
   \item 
     ...
     $$
     \oiint_{\mskip -12mu\partial V} \bdF\circ\widehat\bdN\,dS
...
%  Stokes %<<<
   \item 
     ...
     $\widehat\bdN$)
     $$
     \oint_{\partial S} \bdF\circ d\bdr
     = \iint_{\mskip -12mu S} \Tr{\Curl}{\Rot}\bdF\circ\widehat\bdN\,dS
   = \iint_{\mskip -12mu S} (\nabla\times \bdF)\circ\widehat\bdN\,dS.
     $$
     %>>>
\end{itemize}
\label{LastPageNo}
