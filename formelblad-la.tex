...
%% -- Head && foot
\chead{\ifnum\thepage=1 {} \else \Tr{Formula sheet Linear Algebra}{Formelblad Linjär Algebra}\fi}
\rhead{\ifnum\thepage=1 \textbf{\Tr{Formula sheet LINEAR ALGEBRA}{Formelblad LINJÄR ALGEBRA}}
